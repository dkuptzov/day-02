...
START_TEST(sprintf_test_sprintf38) {
    ...
    ck_assert_int_eq(s21_sprintf(str1, format, 0.0000999, 111.9999, 6.666), sprintf(str2, format, 0.0000999, 111.9999, 6.666));
...
/* ------=====                   START                  =====------ */
    ...
    */
    ...
    tcase_add_test(tc, sscanf_chars_flags3);  // Demonstrates how (*) works. * - ignore the char
