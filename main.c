...
*/
    ...
    //char *format200 = "%.17LE";
    //%0. %.0 %0.0 %1 %1.1 %1.20 %5.5 
    //a = s21_sprintf(str, "%6.1f***%6.1f***%6.1f***%6.1f***%6.1f", 0.0, 123.456, -123.456, -0.00005456, -5565746456.56);
    a = s21_sprintf(str, "%3.1f", 0.0);
    printf("STR1_200: %d * %s\n", a, str);
    //a = sprintf(str2, "%6.1f***%6.1f***%6.1f***%6.1f***%6.1f", 0.0, 123.456, -123.456, -0.00005456, -5565746456.56);
    a = sprintf(str2, "%3.1f", 0.0);
    printf("STR2_200: %d * %s\n", a, str2);
    clear(&str, &str2);
    printf("=================================================================\n");
    printf("%%c\n");
